...
text = "TEO TEAM ANBAR"
art = cprint(figlet_format(text, font="basic", width=49), 'red')
print_grey = lambda x: cprint(x, 'grey', 'on_red')
...
def main():
    while 1:
        ...
        art
        print_blue("-"*49+"\n")
        print_grey("  فريق TEO الانبار الالكتروني  ")
        print_blue("-"*49+"\n")
